...
class PriceH2CustomRepositoryTest {
  ...
  private static PriceH2 mockPriceH2(long id, OffsetDateTime startDate, OffsetDateTime endDate,
      int priority, double amount) {
  ...
  private static OffsetDateTime getOffsetDateTime(Month month, int day, int hour, int minute,
      int second) {
